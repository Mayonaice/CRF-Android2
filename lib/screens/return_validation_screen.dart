...
class _ReturnValidationScreenState extends State<ReturnValidationScreen> {
  ...
  Future<void> _validateAndGetReplenish() async {
    ...
    try {
      ...
      setState(() {
        _isLoading = false;
        _validationSuccess = result['success'] ?? false;
  ...
  void _showDetailedErrorDialog(String errorMessage) {
    showDialog(
      context: context,
